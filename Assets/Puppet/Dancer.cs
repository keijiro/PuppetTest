    ...
    public class Dancer : MonoBehaviour
    {
        ...
        Vector3 BodyPosition {
            get {
                ...
                pivot.y = 0;
                return pivot + Vector3.up * (_bodyHeight + Mathf.Cos(StepFracTime * Mathf.PI * 4) * _stepHeight / 2);
            }
        }
        ...
        void OnAnimatorIK(int layerIndex)
        {
            ...
            var twist = Quaternion.AngleAxis(-8, Vector3.forward) * _bodyNoise.Rotation(5, 30, 20, 20);
